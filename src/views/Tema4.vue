...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.overflow-hidden
        ...
        .tarjeta.color-acento-botones-cv.p-4.rounded-3.mb-0(data-aos="zoom-in-right")
          .row.justify-content-center.align-items-center.mb-0
            .col-12.col-lg-9.order-2.order-lg-1(data-aos="zoom-in-right")
              p.mb-0 Comprender cómo se segmenta el mercado, cuáles variables intervienen en el proceso y cómo se selecciona el mercado objetivo facilita la toma de decisiones estratégicas orientadas a la competitividad empresarial. La correcta segmentación permite que los productos y servicios ofrecidos respondan de manera efectiva a las expectativas del consumidor, fortaleciendo la relación empresa-cliente y aumentando las probabilidades de éxito comercial.
    ...
    #t_4_1.titulo-segundo.color-acento-contenido
      .h2(data-aos="fade-right") 4.1 Concepto y objetivos
    .mb-0 
          ...
          .col-12.col-md-6.col-lg-6.mb-3(data-aos="zoom-in-right")
            .tarjeta.color-acento-contenido-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
              .row.justify-content-center.align-items-center.mb-0
                ...
                .col-12.col-lg-9.mb-0
                  h5.mb-3 Identificación de oportunidades
                  p.mb-0 Detecta necesidades específicas de grupos de consumidores.
          .col-12.col-md-6.col-lg-6.mb-3(data-aos="zoom-in-right")
            .tarjeta.color-acento-contenido-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
              .row.justify-content-center.align-items-center.mb-0
                .col-4.col-lg-3.mb-0
                ...
                .col-12.col-lg-9.mb-0
                  h5.mb-3 Optimización de recursos
                  p.mb-0 Permite dirigir esfuerzos comerciales a segmentos rentables.
          .col-12.col-md-6.col-lg-6.mb-3(data-aos="zoom-in-right")
            .tarjeta.color-acento-contenido-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
              .row.justify-content-center.align-items-center.mb-0
                .col-4.col-lg-3.mb-0
                ...
                .col-12.col-lg-9.mb-0
                  h5.mb-3 Diferenciación competitiva
                  p.mb-0 Facilita el diseño de ofertas especializadas.
          .col-12.col-md-6.col-lg-6.mb-3(data-aos="zoom-in-right")
            .tarjeta.color-acento-contenido-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
              .row.justify-content-center.align-items-center.mb-0
                .col-4.col-lg-3.mb-0
                ...
                .col-12.col-lg-9.mb-0
                  h5.mb-3 Mejora del posicionamiento
                  p.mb-0 Fortalece la percepción de valor del producto.
          
    Separador

    #t_4_2.titulo-segundo.color-acento-contenido
      .h2(data-aos="fade-right") 4.2 Variables
    .mb-0 
    ...
    p.mb-3(data-aos="zoom-in-right") Variables de segmentación y características
        ...
        .tarjeta.color-acento-botones-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
          .row.justify-content-center.align-items-center.mb-0
            ...
            .col-12.col-lg-8.mb-0
              h5.mb-0 Demográfica
              p.mb-0 Edad, género, ingresos, educación, ocupación.
      .col-12.col-md-6.col-lg-3.mb-3.mb-lg-0(data-aos="zoom-in-right")
        .tarjeta.color-acento-botones-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
          .row.justify-content-center.align-items-center.mb-0
            .col-4.col-lg-4.mb-0
            ...
            .col-12.col-lg-8.mb-0
              h5.mb-0 Geográfica
              p.mb-0 País, región, clima, densidad poblacional.
      .col-12.col-md-6.col-lg-3.mb-3.mb-lg-0(data-aos="zoom-in-right")
        .tarjeta.color-acento-botones-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
          .row.justify-content-center.align-items-center.mb-0
            .col-4.col-lg-4.mb-0
            ...
            .col-12.col-lg-8.mb-0
              h5.mb-0 Psicográfica
              p.mb-0 Estilo de vida, valores, intereses, personalidad.
      .col-12.col-md-6.col-lg-3.mb-3.mb-lg-0(data-aos="zoom-in-right")
        .tarjeta.color-acento-botones-cv.p-4.rounded-4.mb-0.h-100.d-flex.align-items-center.justify-content-center
          .row.justify-content-center.align-items-center.mb-0
            .col-4.col-lg-4.mb-0
            ...
            .col-12.col-lg-8.mb-0
              h5.mb-0 Conductual
              p.mb-0 Frecuencia de compra, beneficios buscados, fidelidad.
          ...
          blockquote.cita-decorada__caja.cita-decorada__caja--fondo-1.p-5
            .row.justify-content-center.align-items-center.mb-lg-0.mb-5
              .col-7.col-lg-5.position-relative.order-2.order-lg-1.mb-0
                figure
                  img(src='@/assets/curso/tema4/img_22.png', class="cita-decorada__imagen-flotante-6")
              .col-10.col-lg-7.order-1.order-lg-2.mb-lg-0.mb-5
                .bloque-texto-b.cita-decorada__texto.mb-1.p-0
                  .bloque-texto-b__texto
                    i.fas.fa-quote-left
                    h5.mb-0 Comprender al consumidor con honestidad y respeto permite diseñar estrategias de mercado que generen valor sin perder la integridad empresarial.
